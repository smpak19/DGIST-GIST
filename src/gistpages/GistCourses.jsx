...
import CourseInfo from "../Component/GistCourseInfo";
...
function GistCourses( {userId, setId} ) {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        let SI = loc.state.SI
        let major = loc.state.major
        nav("/gistresult", {state: {arr: isheard, num: SI, Major: major}})
        axios.post("http://192.249.18.176:443/user", {userid : {userId} , taken : {isheard}, SI: {SI}, School: "gist", Major: {major}});
    }
